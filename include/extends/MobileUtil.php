...
class MobileUtil{
	...
	static function getTerminal($ip = null){
		...
		//2010年08月09日現在最新ＩＰリスト

		$IP_DOCOMO	= array();
		$IP_AU 		= array();
		$IP_SOFTBANK = array();
		
		//2012年10月09日確認(2011年5月更新 サイト側更新
		...
		//2012年10月09日確認(2012年7月25日サイト側更新
...
*/		
		...
		$IP_SOFTBANK[] = "202.253.96.0/28"; //純正フルブラウザ
		
/*
		$IP_SOFTBANK[] = "123.108.237.240/28"; //純正フルブラウザ
*/
