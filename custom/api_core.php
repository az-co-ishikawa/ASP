<?php
	...
	class Api_core
	{
		 ...
		 * 広告の取得。
		 * 
		 * @param id 広告を取得する広告主のID。
		 */
		function load_adwares( $param )
		{
			global $gm;
			print $gm['cUser']->getCCResult( null, '<!--# code tableSelectForm adwares adwares name id  未選択  cuser = '.$param['id'].' #-->' );
		}
		 ...
		 * @param id 広告を取得する広告主のID。
		 */
		function load_secret_adwares( $param )
		{
			global $gm;
			print $gm['cUser']->getCCResult( null, '<!--# code tableSelectForm adwares secretAdwares name id  未選択  cuser = '.$param['id'].' #-->' );
		}
